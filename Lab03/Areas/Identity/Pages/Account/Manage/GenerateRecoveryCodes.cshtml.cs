    ...
    public class GenerateRecoveryCodesModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (user == null)
            {
                ...
                return NotFound($"Không thể tải người dùng bằng mã '{_userManager.GetUserId(User)}'.");
            }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("Người dùng có mã '{UserId}' đã tạo mã khôi phục 2FA mới", userId);
